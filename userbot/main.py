...
UNAPPROVED_MSG = ("`Hey! Bu bir CeteUserBot. Endişelenme.\n\n`"
...
try:
    ...
    PLUGIN_MESAJLAR = {}
    ORJ_PLUGIN_MESAJLAR = {"alive": "`Merhaba 💋 CeteUserBot Çalışıyor ✨.`", "afk": str(choice(AFKSTR)), "kickme": "Güle Güle ben gidiyorum 🤠", "pm": UNAPPROVED_MSG, "dızcı": str(choice(DIZCILIK_STR))}
